...
```powershell
cmake -S . -B build/MSVC2022_Qt6_5_Debug
cmake --build build/MSVC2022_Qt6_5_Debug --config Debug
```
...
```powershell
windeployqt --qmldir . build/MSVC2022_Qt6_5_Debug/QtComAssistant.exe
```
